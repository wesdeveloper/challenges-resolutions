/** 
reference: https://www.codewars.com/kata/54c27a33fb7da0db0100040e
...
export default function isSquare(n: number): boolean {
  ...
  // for (let index = 0; index <= n; index++) {  // for (let index = 0; index <= n; index++) {  // for (let index = 0; index <= n; index++) {  // for (let index = 0; index <= n; index++) {  //   if (index * index === n) {
  //     isSquare = true;
  //     break;
  //   }
  // }
